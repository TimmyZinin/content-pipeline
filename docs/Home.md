...
- [[CTA-Placement]] — матрица размещения ссылок по платформам
- [[Runbook]] — диагностика: почему пост не вышел, восстановление, мониторинг
...
| 6 | Publisher v3 | ✅ Active (13 платформ + Quality Gate) | ErbbScuvxWHLX1np | */30 09-03 Istanbul |
