...
| # | Платформа | Язык | Частота | Время (Dubai) | Метод | Publisher статус |
|---|-----------|------|---------|---------------|-------|----------------|
...
## Не подключены в Adapter (бэклог)

| Платформа | Язык | Адаптер в auto-publisher | Приоритет |
|-----------|------|-------------------------|-----------|
| Write.as | EN | ✅ writeas.py | Спринт 3 |
| Tumblr | EN | ✅ tumblr.py | Спринт 3 |
| Minds | EN | ✅ minds.py | Спринт 3 |
| Nostr | EN | ✅ nostr.py | Спринт 3 |
| Twitter/X | EN | Через Publer | Спринт 3 |
| Medium | EN | Нет API | Бэклог |
| VC.ru | RU | Нет адаптера | Бэклог |
